...
const ButtonTheme = {
  ...
  colors: {
    ...
    secondary: "",
    transparent:
      "bg-transparent active:bg-gray-100 dark:active:bg-gray-800 text-slate-950 dark:text-gray-400 disabled:bg-gray-100 disabled:dark:bg-gray-700 disabled:text-gray-400 disabled:dark:text-gray-500 font-normal",
    transparentInverse:
